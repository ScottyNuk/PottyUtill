package net.potty.pottyutil.block.custom;
...
public class PedestalBlock2 extends BlockWithEntity implements BlockEntityProvider {

    private static final VoxelShape SHAPE =
            Block.createCuboidShape(4, 0, 4, 12, 12, 12);
    public static final MapCodec<PedestalBlock2> CODEC = PedestalBlock2.createCodec(PedestalBlock2::new);

    public PedestalBlock2(Settings settings) {
        super(settings);
    }
